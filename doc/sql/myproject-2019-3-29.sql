...
CREATE TABLE `b_mq_message_producer` (
  ...
  `MESSAGE` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '发送的具体消息',
...
-- ----------------------------
-- Table structure for b_web_socket_info
-- ----------------------------
DROP TABLE IF EXISTS `b_web_socket_info`;
CREATE TABLE `b_web_socket_info` (
  `ID` bigint(11) NOT NULL,
  `MESSAGE` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '消息主体',
  `SENDER` varchar(255) DEFAULT NULL COMMENT '消息发送人',
  `SENDER_CODE` varchar(255) DEFAULT NULL COMMENT '消息发送人Code',
  `RECEIVE` varchar(255) DEFAULT NULL COMMENT '消息接收人',
  `RECEIVE_BRANCH_CODE` varchar(255) DEFAULT NULL COMMENT '消息接收人分公司',
  `RECEIVE_CODE` varchar(255) DEFAULT NULL COMMENT '消息接收人Code',
  `STATUS` varchar(255) DEFAULT NULL COMMENT '状态 0未读 1已读',
  `TASK_CREATE_TIME` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '任务创建时间',
  `OPERATE_VERSION` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `CREATED_BY` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `UPDATED_BY` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `UPDATED_ON` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
