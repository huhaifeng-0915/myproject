...
-- ----------------------------
-- Table structure for b_mq_fail_consumer
-- ----------------------------
DROP TABLE IF EXISTS `b_mq_fail_consumer`;
CREATE TABLE `b_mq_fail_consumer` (
  `CONSUMER_ID` bigint(20) NOT NULL,
  `PRODUCER_ID` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '生产者主键',
  `RESULT` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '处理结果',
  `CONSUMER_TIMES` int(11) DEFAULT NULL COMMENT '消费次数',
  `CONSUMER_IP` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '消费IP',
  `QUEUE` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '队列代码',
  `CONSUMER_TIME` date DEFAULT NULL COMMENT '消费时间',
  `CONCURRENCY_STATUS` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '并发状态',
  `OPERATE_VERSION` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `CREATED_BY` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `UPDATED_BY` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `UPDATED_ON` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
...
-- ----------------------------
-- Table structure for b_mq_handling_consumer
-- ----------------------------
DROP TABLE IF EXISTS `b_mq_handling_consumer`;
CREATE TABLE `b_mq_handling_consumer` (
  `CONSUMER_ID` bigint(20) NOT NULL,
  `PRODUCER_ID` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '生产者主键',
  `RESULT` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '处理结果',
  `CONSUMER_TIMES` int(11) DEFAULT NULL COMMENT '消费次数',
...
-- ----------------------------
-- Table structure for b_mq_message_producer
-- ----------------------------
DROP TABLE IF EXISTS `b_mq_message_producer`;
CREATE TABLE `b_mq_message_producer` (
  `PRODUCER_ID` bigint(20) NOT NULL,
  `BUSINESS_NO` varchar(255) DEFAULT NULL COMMENT '业务流水号',
  `EXCHANGE` varchar(255) DEFAULT NULL COMMENT '交换机名称',
  `ROUTING_KEY` varchar(255) DEFAULT NULL COMMENT '路由key',
  `PRODUCER_IP` varchar(255) DEFAULT NULL COMMENT '生产者IP',
  `MESSAGE` varchar(255) DEFAULT NULL COMMENT '发送的具体消息',
  `SEND_TIME` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '该条消息指定的发送时间,如果为null或者小于当前时间则表示马上发送',
  `SEND_TIMES` int(16) DEFAULT NULL COMMENT '发送次数',
  `OPERATE_VERSION` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `CREATED_BY` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `UPDATED_BY` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `UPDATED_ON` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
...
-- ----------------------------
-- Table structure for b_mq_success_consumer
-- ----------------------------
DROP TABLE IF EXISTS `b_mq_success_consumer`;
CREATE TABLE `b_mq_success_consumer` (
  `CONSUMER_ID` bigint(20) NOT NULL,
  `PRODUCER_ID` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '生产者主键',
  `RESULT` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '处理结果',
  `CONSUMER_TIMES` int(11) DEFAULT NULL COMMENT '消费次数',
